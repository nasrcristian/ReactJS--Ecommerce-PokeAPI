        ...
        <article className={`${pokemon.types[0].type.name}Background cardContainer`}>
                    ...
                    <section className='detailsContainer'>
                        <div className='d-FlexRow typesContainer'>
                            <h5><p className={`${pokemon.types[0].type.name}Background`}>{pokemon.types[0].type.name}</p></h5>
                            {pokemon.types[1]? (<h5><p className={`${pokemon.types[1].type.name}Background`}>{pokemon.types[1].type.name}</p></h5>): null}
